...
filename = "/users/didarsedghi/Desktop/Conventional Mossbauer/run 2 (stainless steel) ascii.asc"
...
plt.title("Steel Sample Conventional")
plt.xlabel("Channel")
plt.ylabel("Counts")
plt.plot(x_channel, y_count, "r")
plt.show()
