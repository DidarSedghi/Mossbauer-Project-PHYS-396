...
filename = "/users/didarsedghi/Desktop/Mossbauer Experiment/Steel Sample/Different Passes (Steel) (new cm)/500 pass ascii (s) (NEW).asc"
...
# mean 
y = [13.717 for i in x_channel]


plt.title("500 pass Steel sample")
plt.xlabel("Channel")
plt.ylabel("Counts")
plt.plot(x_channel, y_count, "o", color="g")
